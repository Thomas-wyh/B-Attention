...
from data_analysis import eval_and_plot, plot_figures, cluster_size_hist
...
anno_dicts = {'ablation_fusion':anno_ablation_fusion,
                ...
                'map_vs_npr_celeb_part1':anno_effectiveness_different_benchmarks
}
...
color_dicts = {'ablation_fusion':color_ablation_fusion,
                ...
                'map_vs_npr_celeb_part1':color_effectiveness_different_benchmarks
}
...
line_dicts = {'ablation_fusion':line_ablation_fusion,
                ...
                'map_vs_npr_celeb_part1':line_effectiveness_different_benchmarks
}
...
zoomed_x_dict = {'ablation_fusion':[0, 0.15],
                ...
                'performance_msmt':[0.01, 0.21],
                'performance_veri':[0.05, 0.25]
}
...
zoomed_y_dict = {'ablation_fusion':[0.85, 1.0],
                ...
                'performance_msmt':[0.71, 0.91],
                'performance_veri':[0.7, 0.9]
}
...
if __name__ == "__main__":
    ...
    plot_figures(x_values, y_values, annos, colors, lines, predicts_prefix)
